...
const createButton = (text, activeColor = '#4CAF50') => {
    ...
    button.style.boxShadow = '0 6px 15px rgba(0, 0, 0, 0.5)';
    button.style.fontFamily = 'Arial, sans-serif';

    button.onmousedown = () => {
        button.style.backgroundColor = activeColor;
        button.style.boxShadow = '0 8px 20px rgba(0, 0, 0, 0.7)';
    };
...
autoLoadButton.addEventListener('click', () => {
    ...
    autoLoadButton.style.backgroundColor = autoLoadEnabled ? '#4CAF50' : '#444';
    if (autoLoadEnabled) {
...
const showPromptOverlay = () => {
    ...
    newPromptInput.style.borderRadius = '8px';
    newPromptInput.style.border = '1px solid #777';
...
floatingUI.style.padding = '15px';
floatingUI.style.borderRadius = '16px';
floatingUI.style.boxShadow = '0 8px 20px rgba(0,0,0,0.5)';
